...
fun SelectVMTemplateComponent() {
    ...
    // Load templates
    val templatesURL = "file:///android_asset/templates.yaml"
    ...
    val onSelect = { item: VMTemplate ->
        ...
        // Start the Create VM activity
        val intent = Intent(ctx, CreateVMActivity::class.java)
        intent.putExtra("config-url", templatesURL)
        intent.putExtra("vm-id", item.id)
            ...
            Column(
                ...
                templates.forEach {
                    ...
                    Row(
                        ...
                        // Icon
                        AsyncImage(
                            model = it.icon ?: "file:///android_asset/icons/server.png",
